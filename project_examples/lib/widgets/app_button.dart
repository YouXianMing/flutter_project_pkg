  ...
  Widget build(BuildContext context) {
    ...
    switch (style) {
      case AppButtonStyle.blue:
        ...
        if (borderRadius > 0) {
          normalDecoration = BoxDecoration(color: nColor, borderRadius: BorderRadius.all(Radius.circular(borderRadius)));
          highlightedDecoration = BoxDecoration(color: hColor, borderRadius: BorderRadius.all(Radius.circular(borderRadius)));
          disabledDecoration = BoxDecoration(color: dColor, borderRadius: BorderRadius.all(Radius.circular(borderRadius)));
        } else {
          normalColor = nColor;
