...
class ListItemCell extends StatelessWidget {
  ...
  const ListItemCell({Key? key, required this.content, this.onTap, this.contentWidget, this.type = ListItemViewType.normal})
      : super(key: key);
