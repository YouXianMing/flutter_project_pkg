...
/// [Samples] provides some simple examples of all 4 main classes [WidgetAnimator],
/// [WidgetAnimatorSequence], [TextAnimator] and [TextAnimatorSequence]
...
class _SamplesIncomingState extends State<SamplesIncoming> {
  ...
  List<Widget> widgetList = [
    ...
    Center(
      ...
      child: WidgetAnimator(
        incomingEffect: WidgetTransitionEffects.incomingSlideInFromBottom(
            delay: const Duration(milliseconds: 500), duration: const Duration(milliseconds: 1000), curve: Curves.bounceOut),
        child: Container(
          width: 200,
          height: 200,
    ...
    Center(
      ...
      child: WidgetAnimator(
        incomingEffect: WidgetTransitionEffects(
            delay: const Duration(milliseconds: 500), duration: const Duration(milliseconds: 1000), blur: const Offset(20, 0)),
        child: Container(
          width: 200,
          height: 200,
    ...
    Center(
      ...
      child: WidgetAnimator(
        incomingEffect: WidgetTransitionEffects(
            delay: const Duration(milliseconds: 500), duration: const Duration(milliseconds: 1000), blur: const Offset(0, 30)),
        child: Container(
          width: 200,
          height: 200,
    ...
    Center(
      ...
      child: WidgetAnimator(
        incomingEffect: WidgetTransitionEffects(
            delay: const Duration(milliseconds: 500), duration: const Duration(milliseconds: 1000), blur: const Offset(1.5, 1.5)),
        child: Container(
          width: 200,
          height: 200,
    ...
    Center(
      ...
      child: WidgetAnimator(
        incomingEffect: WidgetTransitionEffects(
            delay: const Duration(milliseconds: 500), duration: const Duration(milliseconds: 1000), skew: const Offset(0.4, 0)),
        child: Container(
          width: 200,
          height: 200,
          color: Colors.green,
    ...
    Center(
      ...
      child: WidgetAnimator(
        incomingEffect: WidgetTransitionEffects(
            delay: const Duration(milliseconds: 500), duration: const Duration(milliseconds: 1000), skew: const Offset(0, 0.4)),
        child: Container(
          width: 200,
          height: 200,
          color: Colors.cyan,
    ...
    Center(
      ...
      child: WidgetAnimator(
        incomingEffect: WidgetTransitionEffects(
            delay: const Duration(milliseconds: 500), duration: const Duration(milliseconds: 1000), skew: const Offset(0.4, 0.4)),
        child: Container(
          width: 200,
          height: 200,
          color: Colors.orange,
    ...
    Center(
      ...
      child: WidgetAnimator(
        incomingEffect: WidgetTransitionEffects(
            delay: const Duration(milliseconds: 500), duration: const Duration(milliseconds: 1000), rotation: math.pi / 4),
        child: Container(
          width: 200,
          height: 200,
          color: Colors.purple,
    ...
    Center(
      ...
      child: WidgetAnimator(
        incomingEffect: WidgetTransitionEffects(
            delay: const Duration(milliseconds: 500), duration: const Duration(milliseconds: 1000), rotation: -math.pi / 3),
        child: Container(
          width: 200,
          height: 200,
          color: Colors.red,
    ...
    Center(
      ...
      child: WidgetAnimator(
        incomingEffect: WidgetTransitionEffects.incomingOffsetThenScale(
            delay: const Duration(milliseconds: 500), duration: const Duration(milliseconds: 1000)),
        child: Container(
          width: 200,
          height: 200,
          color: Colors.green,
      ...
      child: WidgetAnimator(
        incomingEffect: WidgetTransitionEffects(
            ...
            builder: (effects, animationController) {
              ...
              AnimationSettings animationSettings = AnimationSettings(animationController: animationController);

              double delay = (effects.delay?.inMilliseconds ?? 0).toDouble();
              double duration = (effects.duration?.inMilliseconds ?? 300).toDouble();

              animationSettings.opacityAnimation = TweenSequence<double>(
              ...
              animationSettings.offsetXAnimation = TweenSequence<double>(
                <TweenSequenceItem<double>>[
                  if (delay > 0)
                    TweenSequenceItem<double>(
                      tween: Tween<double>(begin: 0, end: 0).chain(CurveTween(curve: Curves.linear)),
              ...
              animationSettings.scaleAnimation = TweenSequence<double>(
                <TweenSequenceItem<double>>[
                  if (delay > 0)
                    TweenSequenceItem<double>(
                      tween: Tween<double>(begin: 0, end: 0).chain(CurveTween(curve: Curves.linear)),
          ...
          children: [
            ...
            Row(
              ...
              children: [
                WidgetAnimator(
                  incomingEffect: WidgetTransitionEffects.incomingSlideInFromBottom(
                      delay: const Duration(milliseconds: 600), duration: const Duration(milliseconds: 600), curve: Curves.easeOut),
                ...
                WidgetAnimator(
                  incomingEffect: WidgetTransitionEffects.incomingSlideInFromBottom(
                      delay: const Duration(milliseconds: 750), duration: const Duration(milliseconds: 600), curve: Curves.easeOut),
                  child: OutlinedButton(
                      onPressed: () {
                        if (mounted) {
                          setState(() {
          ...
          children: [
            ...
            Row(
              ...
              children: [
                WidgetAnimator(
                  incomingEffect:
                      WidgetTransitionEffects.incomingSlideInFromBottom(duration: const Duration(milliseconds: 600), curve: Curves.easeOut),
                  child: OutlinedButton(
                      onPressed: () {
                        if (mounted) {
                          setState(() {
                ...
                WidgetAnimator(
                  incomingEffect: WidgetTransitionEffects.incomingSlideInFromBottom(
                      delay: const Duration(milliseconds: 150), duration: const Duration(milliseconds: 600), curve: Curves.easeOut),
                  child: OutlinedButton(
                      onPressed: () {
                        if (mounted) {
                          setState(() {
...
class _OutgoingSlideOutBottomCustomCurveState extends State<_OutgoingSlideOutBottomCustomCurve> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
        ...
        child: WidgetAnimator(
            outgoingEffect:
                WidgetTransitionEffects.outgoingSlideOutToBottom(curve: Curves.elasticIn, duration: const Duration(milliseconds: 1500)),
            onOutgoingAnimationComplete: (_) async {
              await Future.delayed(const Duration(seconds: 1));
              if (mounted) {
                if (mounted) {
    ...
    return GestureDetector(
        ...
        child: WidgetAnimator(
            outgoingEffect: WidgetTransitionEffects(
                rotation: math.pi / 5, blur: const Offset(2, 2), skew: const Offset(0.3, 0.2), offset: const Offset(30, 40), scale: 0.5),
            onOutgoingAnimationComplete: (_) async {
              await Future.delayed(const Duration(seconds: 1));
              if (mounted) {
                setState(() {
    ...
    return GestureDetector(
        ...
        child: WidgetAnimator(
            outgoingEffect: WidgetTransitionEffects.outgoingOffsetThenScale(
                duration: const Duration(milliseconds: 500), delay: const Duration(milliseconds: 0)),
            onOutgoingAnimationComplete: (_) async {
              await Future.delayed(const Duration(seconds: 1));
              if (mounted) {
                setState(() {
        ...
        child: WidgetAnimator(
            outgoingEffect: WidgetTransitionEffects(
                ...
                builder: (effects, animationController) {
                  ...
                  animationSettings.offsetYAnimation = TweenSequence<double>(
                    <TweenSequenceItem<double>>[
                      if (delay > 0)
                        TweenSequenceItem<double>(
                          tween: Tween<double>(begin: 0, end: 0).chain(CurveTween(curve: Curves.linear)),
      ...
      child: WidgetAnimator(
        atRestEffect: WidgetRestingEffects(
          builder: (WidgetRestingEffects effects, AnimationController animationController) {
            ...
            animationSettings.rotationAnimation = TweenSequence<double>(
              <TweenSequenceItem<double>>[
                TweenSequenceItem<double>(
...
class _SamplesTextState extends State<SamplesText> {
  ...
  void initState() {
    ...
    _settingsList.add(_SampleTextSettings(
      text: 'Sample Ten',
      incomingEffect:
          WidgetTransitionEffects(skew: const Offset(0.3, 0), curve: Curves.easeOut, duration: const Duration(milliseconds: 900)),
    ...
    _settingsList.add(_SampleTextSettings(
      text: 'Sample Eleven',
      incomingEffect: WidgetTransitionEffects(
          offset: const Offset(-60, 0), blur: const Offset(10, 0), curve: Curves.easeInOut, duration: const Duration(milliseconds: 400)),
      outgoingEffect: WidgetTransitionEffects(
          offset: const Offset(60, 0), blur: const Offset(10, 0), curve: Curves.easeIn, duration: const Duration(milliseconds: 400)),
      atRestEffect: WidgetRestingEffects.none(),
    ...
    _settingsList.add(_SampleTextSettings(
      text: 'Sample Twelve',
      incomingEffect: WidgetTransitionEffects(
          offset: const Offset(0, 80), blur: const Offset(0, 20), curve: Curves.easeInOut, duration: const Duration(milliseconds: 300)),
      outgoingEffect: WidgetTransitionEffects(
          offset: const Offset(0, 80), blur: const Offset(0, 20), curve: Curves.easeIn, duration: const Duration(milliseconds: 300)),
      atRestEffect: WidgetRestingEffects.none(),
      ...
      children: [
        TextAnimator('Red',
            ...
            style: GoogleFonts.sanchez(
                textStyle: const TextStyle(fontWeight: FontWeight.w900, color: Colors.red, letterSpacing: -2, fontSize: 64))),
        TextAnimator('Green',
            incomingEffect: WidgetTransitionEffects.incomingSlideInFromLeft(),
            atRestEffect: WidgetRestingEffects.fidget(),
            outgoingEffect: WidgetTransitionEffects.outgoingSlideOutToBottom(),
            style: GoogleFonts.sanchez(
                textStyle: const TextStyle(fontWeight: FontWeight.w900, color: Colors.green, letterSpacing: -2, fontSize: 64))),
        TextAnimator('Blue',
            incomingEffect: WidgetTransitionEffects(blur: const Offset(2, 2), duration: const Duration(milliseconds: 600)),
            atRestEffect: WidgetRestingEffects.wave(),
            outgoingEffect: WidgetTransitionEffects(blur: const Offset(2, 2), duration: const Duration(milliseconds: 600)),
            style: GoogleFonts.sanchez(
                textStyle: const TextStyle(fontWeight: FontWeight.w900, color: Colors.blue, letterSpacing: -2, fontSize: 64))),
      ],
    );
  }
}
