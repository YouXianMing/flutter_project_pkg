...
class ConfettiWidgetPage extends NormalStatefulWidget {
  @override
  final PageArguments? arguments;

  const ConfettiWidgetPage({Key? key, this.arguments}) : super(key: key);

  @override
  BaseStatefulWidgetState<BaseStatefulWidget> createWidgetState() => ConfettiWidgetPageState();
}

class ConfettiWidgetPageState extends NormalStatefulWidgetState<ConfettiWidgetPage> {
