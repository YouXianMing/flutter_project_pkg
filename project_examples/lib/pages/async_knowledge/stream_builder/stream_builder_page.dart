...
class StreamBuilderPage extends NormalStatefulWidget {
  ...
  @override
  BaseStatefulWidgetState<BaseStatefulWidget> createWidgetState() => StreamBuilderPageState();
}

class StreamBuilderPageState extends NormalStatefulWidgetState<StreamBuilderPage> {
  Stream? _stream;
