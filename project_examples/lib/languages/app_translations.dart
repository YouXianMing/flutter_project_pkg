...
const Map<String, dynamic> _translations = {
  ...
  '更新数据': {_zh: '更新数据', _en: 'Update data'},
  '重置': {_zh: '重置', _en: 'Reset'},
  '刮开': {_zh: '刮开', _en: 'Scrape open'},
  '正面': {_zh: '正面', _en: 'Front'},
  '反面': {_zh: '反面', _en: 'Reverse side'},
  '翻转': {_zh: '翻转', _en: 'Flip'},
  '随机角度': {_zh: '随机角度', _en: 'Random angle'},
  '暗示(该控件可以翻转)': {_zh: '暗示(该控件可以翻转)', _en: 'Hint (the widget can be flipped)'},
  'SliverSectionTip1': {_zh: 'SliverWaterfallFlowSection.builder (点击我)', _en: 'SliverWaterfallFlowSection.builder (Tap me)'},
  'SliverSectionTip2': {
  ...
  '数据': {_zh: '数据', _en: 'Data'},
  '点击我': {_zh: '点击我', _en: 'Tap me'},
  '点击更新': {_zh: '点击更新', _en: 'Click to update'},
  '点击重试': {_zh: '点击重试', _en: 'Click to try again'},
  '很抱歉,出错啦': {_zh: '很抱歉,出错啦', _en: 'Sorry, something went wrong'},
  '等待中': {_zh: '等待中', _en: 'Waiting'},
  '结果': {_zh: '结果', _en: 'Result'},
  '开始': {_zh: '开始', _en: 'Start'},
  '运行中': {_zh: '运行中', _en: 'Running'},
  '结束': {_zh: '结束', _en: 'Finish'},
};
