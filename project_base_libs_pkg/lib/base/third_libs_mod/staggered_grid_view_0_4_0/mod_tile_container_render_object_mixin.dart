...
/// in a HashMap.
mixin ModTileContainerRenderObjectMixin<ChildType extends RenderObject, ParentDataType extends ParentData> on RenderObject {
  ...
  bool debugValidateChild(RenderObject child) {
    assert(() {
      if (child is! ChildType) {
        throw FlutterError('A $runtimeType expected a child of type $ChildType but received a '
  ...
  List<DiagnosticsNode> debugDescribeChildren() {
    ...
    _childRenderObjects.forEach((index, child) => children.add(child.toDiagnosticsNode(name: 'child $index')));
    return children;
  }
}
