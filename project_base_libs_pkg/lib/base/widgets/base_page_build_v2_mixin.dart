...
mixin BasePageBuildV2Mixin {
  /// (abstract) 获取首次加载数据的控件,如果需要加载网络请求,需要重写该方法
  Widget futureLoadingWidget(BuildContext context);
  ...
  Widget buildRootWidget(BuildContext context) {
    return Stack(
      children: [
        ...
        firstTimeLoadingWidgetIsOutSideAppBar ? futureLoadingWidget(context) : const SizedBox(),
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          firstTimeLoadingWidgetIsOutSideAppBar ? const SizedBox() : futureLoadingWidget(context),
