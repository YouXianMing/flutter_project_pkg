...
ThemeData noSplashFactoryThemeData(BuildContext context) => Theme.of(context).copyWith(highlightColor: Colors.transparent, splashFactory: const NoSplashFactory());

/// 用于普通控件上的无波纹的theme
Theme noSplashTheme({required Widget child}) => Theme(data: ThemeData(splashFactory: const NoSplashFactory(), highlightColor: Colors.transparent), child: child);
